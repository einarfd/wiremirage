...
- **GitHub-only.** Tempting because GitHub org membership is a stronger trust claim than email domain. Rejected because Kindly (and most teams) have non-engineering users who may need access without a GitHub account, and constraining to GitHub closes that door.
